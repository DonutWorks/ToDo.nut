module HistoriesHelper
  ...
  def replace_todo_reference(reference)
    ...
    if found
      link_to "#{found.title}(#{reference})", project_todo_path(@project.project_owner, @project.title, found.ptodo_id)
    else
      reference
    end
  end
  ...
  def replace_history_reference(reference)
    ...
    if found
      link_to "#{found.title}(#{reference})", project_history_path(@project.project_owner, @project.title, found.phistory_id)
    else
      reference
    end
  end
